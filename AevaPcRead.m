function pc_data = AevaPcRead(filename)
    %% READ IN THE TESTING DATA
% Read point clouds from Aeva raw .h5 data and return point cloud struct
% Data file
% filename = 'traj1_test3_int'; % INPUT FILE NAME HERE
